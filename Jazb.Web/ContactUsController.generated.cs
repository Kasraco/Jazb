...
namespace Jazb.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ContactUsController : Jazb.Web.Controllers.ContactUsController
    {
        ...
        [NonAction]
        partial void SubmitOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Jazb.DomainClasses.Entities.FAQ model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Submit(Jazb.DomainClasses.Entities.FAQ model)
        {
