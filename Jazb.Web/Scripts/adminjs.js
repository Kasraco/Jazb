...
var LogOnBigForm = new Object();

LogOnBigForm.onSuccess = function () {
    $('#logOnModalBig').modal('show');
};



LogOnBigForm.onEndSuccess = function () {
    $('#logOnModalBig').modal('hide');
};
...
LogOnForm.onEndSuccess = function () {
        ...
        complete: function (response, status) {
            ...
            if (caller.attr('data-i-show-dialog') == "true") {
                ...
                run(function () {
                    ...
                    $('.date-pickers').datepicker({ changeMonth: true, changeYear: true })
                });
            }
