...
namespace Jazb.Web.Areas.Admin.Controllers
{
    public partial class JobController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public JobController Actions { get { return MVC.Admin.Job; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Add = "~/Areas/Admin/Views/Job/_Add.cshtml";
            public readonly string _Edit = "~/Areas/Admin/Views/Job/_Edit.cshtml";
            public readonly string _Index = "~/Areas/Admin/Views/Job/_Index.cshtml";
            public readonly string _List = "~/Areas/Admin/Views/Job/_List.cshtml";
            public readonly string _Nav = "~/Areas/Admin/Views/Job/_Nav.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_JobController : Jazb.Web.Areas.Admin.Controllers.JobController
    {
        ...
        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string term, int page, int count, Jazb.Servicelayer.EFServices.Enums.Order order, Jazb.Servicelayer.EFServices.Enums.JobOrderBy orderBy, Jazb.Servicelayer.EFServices.Enums.JobSearchBy searchBy);

        [NonAction]
        public override System.Web.Mvc.ActionResult List(string term, int page, int count, Jazb.Servicelayer.EFServices.Enums.Order order, Jazb.Servicelayer.EFServices.Enums.JobOrderBy orderBy, Jazb.Servicelayer.EFServices.Enums.JobSearchBy searchBy)
        {
        ...
        [NonAction]
        partial void AddOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Jazb.Model.AdminModel.JobViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Add(Jazb.Model.AdminModel.JobViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Add);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Jazb.Model.AdminModel.JobViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Jazb.Model.AdminModel.JobViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
