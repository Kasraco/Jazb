...
namespace Jazb.Web.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_MailController : Jazb.Web.Areas.Admin.Controllers.MailController
    {
        ...
        [NonAction]
        partial void SendOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Jazb.Model.AdminModel.SendingMailModel mailModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Send(Jazb.Model.AdminModel.SendingMailModel mailModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Send);
