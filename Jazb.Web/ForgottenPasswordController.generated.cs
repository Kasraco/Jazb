...
namespace Jazb.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ForgottenPasswordController : Jazb.Web.Controllers.ForgottenPasswordController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Jazb.Model.ForgottenPasswordModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(Jazb.Model.ForgottenPasswordModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
